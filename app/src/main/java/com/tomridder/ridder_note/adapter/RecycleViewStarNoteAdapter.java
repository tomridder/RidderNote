...
public class RecycleViewStarNoteAdapter extends BaseQuickAdapter<Note,BaseViewHolder>
{
    public RecycleViewStarNoteAdapter(int layoutResId, @Nullable List<Note> data)
    {
